...
if (isset($postdata) && !empty($postdata)) {
 ...
 $lec_dep = mysqli_real_escape_string($con, trim($request->lec_dep));
  ...
  // Create.
  $sql = "INSERT INTO `lecturer`(`lec_id`, `lec_dep`, `lec_name`, `lec_email`) VALUES ('{$lec_id}','{$lec_dep}','{$lec_name}'),'{$lec_email}')";
